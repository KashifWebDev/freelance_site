                        ...
                        <div class="py-28 px-20">
                            ...
                            <div class="mt-24">
                                ...
                                <div class="d-flex flex-wrap justify-content-between gap-3">
                                    <div>
                                        <p class="text-sm mb-0"><span class="text-white fw-semibold">Sales By:</span> Jammal</p>
                                    ...
                                    <div>
                                        <table class="text-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-16">
                                                    <span class="text-white fw-semibold">$4000.00</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="pe-64">Discount:</td>
                                                <td class="pe-16">
                                                    <span class="text-white fw-semibold">$0.00</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-16 pt-4">
                                                    <span class="text-white fw-semibold">$1690</span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
