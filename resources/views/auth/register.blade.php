...
<head>
    ...
    <title>Freelance Site | Register</title>
        ...
        <div class="max-w-464-px mx-auto w-100">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="icon-field mb-16">
                    ...
                    <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Name"
                ...
                <div class="mb-20">
                    <div class="position-relative ">
                        <div class="icon-field">
                            ...
                            <input type="password" class="form-control h-56-px bg-neutral-50 radius-12"  placeholder="Confirm Password"
