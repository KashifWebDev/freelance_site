...
@php
    ...
    $subTitle = 'Freelancer Contracts';
@endphp

@section('content')
    <div class="card basic-data-table">
        <div class="card-header">
            <h5 class="card-title mb-0">Contract Listings</h5>
        </div>
        <div class="card-body">
            <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('client.invoice-show') }}" class="text-primary-600">#526534</a></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list1.png?set=set4" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
                    ...
                    <td>
                        <a href="{{ route('client.invoice-show') }}" class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center">
                            <iconify-icon icon="iconamoon:eye-light"></iconify-icon>
                        </a>
                        <a href="{{ route('client.invoice-show') }}" class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                            <iconify-icon icon="lucide:edit"></iconify-icon>
                        </a>
                        <a href="{{ route('client.invoice-show') }}" class="w-32-px h-32-px bg-danger-focus text-danger-main rounded-circle d-inline-flex align-items-center justify-content-center">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('client.invoice-show') }}" class="text-primary-600">#105986</a></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list5.png') }}" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('client.invoice-show') }}" class="text-primary-600">#526589</a></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list6.png') }}" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('client.invoice-show') }}" class="text-primary-600">#526520</a></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list7.png') }}" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list8.png') }}" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('client.invoice-show') }}" class="text-primary-600">#200257</a></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="https://robohash.org/478251user-list9.png') }}" alt="" class="flex-shrink-0 me-12 radius-8" style="height: 25px">
